...
public class Movie_verionServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if("listTheaters_Bymovie_version_A".equals(action)||"listTheaters_Bymovie_version_B".equals(action)) {
			...
			try {
				...
				Set<TheaterVO> set = movie_versionSvc.getTheatersByMovver_no(movver_no);
		...
		if("listTicket_type_ByMovver_no_A".equals(action)||"listTicket_type_ByMovver_no_B".equals(action)) {
			...
			try {
				...
				Movie_versionService movie_versionSvc = new Movie_versionService();
				Set<Ticket_typeVO> set = movie_versionSvc.getTicket_typeByMovver_no(movver_no);
