...
<jsp:useBean id="listFoos_ByFooCatNo" scope="request" type="java.util.Set<FooVO>" /> <!-- 於EL此行可省略 -->
<jsp:useBean id="fooCatSvc" scope="page" class="com.food_cate.model.FooCatService" />


<html>
<head><title>依據類別搜尋餐點 - listFoos_ByFooCatNo.jsp</title>
...
<table id="table-2">
	<tr><td>
		 <h3>依據類別搜尋餐點 - listFoos_ByFooCatNo.jsp</h3>
...
<table>
	...
	<c:forEach var="fooVO" items="${listFoos_ByFooCatNo}" >
