                ...
                <main>
                    <div class="container-fluid">
                       ...
                       <!-- addMovie Start -->  
						...
						<h3 class="h3-style listOne-h3-pos">餐點新增</h3>
						<table>
							<tr>
								<th>餐點名稱</th>
								<td style="color:red;"><input class="sty-input mr-left mr-btm-normal form-control" type="text" name="fooName" value="${fooVO.fooName}" required/>${errorMsgs.fooName}</td>		
							</tr>
							...
							<tr>
								<th>餐點圖片</th>
								<td>
									<input id="myfile" type="file" name="fooImg" required>${errorMsgs.fooImg}
									<img id="myImg" src="">
								</td>
							</tr>
							...
							<tr>
								<th>餐點售價</th>
								<td style="color:red;"><input class="sty-input mr-left mr-btm-normal form-control" name="fooPrice" type="text" value="${addAdmVO.admMail}" required>${errorMsgs.fooPrice}</td>
							</tr>
