...
<jsp:useBean id="listMember_ByCompositeQuery" scope="request" type="java.util.List<MemberVO>" />
...
<%-- 						</c:if> --%>
                    	...
                    	<div class="row " style="margin: 0px 0 20px -200px;">          
	                        ...
	                        <div class="col-10">          
	                           	<FORM class="form-sty" METHOD="post" ACTION="<%=request.getContextPath() %>/Member/member.do">		
			        				...
			        				<b>會員姓名:</b>
				     				<input type="text" name="mem_Name" value="Jack">
			                        <b>會員帳號:</b>
			         				<input type="text" name="mem_Account" value="abc">
			                        <b>會員信箱:</b>
			         				<input type="text" name="mem_Mail" value="qwe@gmail.com">
                    	...
                    	<!-- listSession Start -->
			             ...
			             <table class="table table-hover">
							...
							<tbody>
							<%@ include file="/back-end/Member/pages/page1_ByCompositeQuery.file" %> 
								<c:forEach var="memberVO" items="${listMember_ByCompositeQuery}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
									...
									<tr class="sty-height" valign='middle'>
										...
										<td>
											<FORM METHOD="post" ACTION="<%=request.getContextPath() %>/Member/member.do">
												<a class="btn btn-light btn-brd grd1 effect-1">
													 <input type="submit" value=${(memberVO.memstatus==0)?"啟動":(memberVO.memstatus==1?"停權":"啟動")} class="input-pos">
												     <input type="hidden" name="memNo"      value="${memberVO.memNo}">
						...
						<%@ include file="/back-end/Member/pages/page2_ByCompositeQuery.file" %> 
                       <!-- listSession End -->
