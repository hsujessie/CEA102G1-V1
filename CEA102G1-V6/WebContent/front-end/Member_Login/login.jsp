...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resource/bootstrap/css2/login01.css">
</head>
<body>
...
<!--============================================================================================-->
		<div class="cotn_principal">
			<div class="cont_centrar">
	           ...
	           <div class="errorMegs"style="border-color:#aaaaee;border-style:solid;border-width:3px 6px;padding:5px;">
					<%-- 錯誤表列 --%>
