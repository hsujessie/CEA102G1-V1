<%@page import="com.art.model.ArtVO"%>
		...
		<form method="POST" action="<%= request.getContextPath()%>/art/art.do">
            ...
            <div class="row">
	            <div class="col-12">
	                ...
	                <input type="hidden" id="atrNo" name="artNo" value="${param.artNo}">
					<input type="hidden" id="artVO" name="artVO" value="${artVO}">
    				<input type="hidden" name="action" value="updateArt">
	            </div>
            </div>
            <div class="row">
	            <div class="col-12">
