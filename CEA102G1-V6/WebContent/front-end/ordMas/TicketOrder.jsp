					...
					<div class="list-group">
						<div class="list-group-item">
							<div class="row">
								...
								<div class="col-3">
									<p>
										<img src="<%=request.getContextPath()%>/resource/images/ordMasIcons/sesTime.png"><span> </span>${sesSvc.getOneSes(1).sesDate} <fmt:formatDate value="${sesSvc.getOneSes(1).sesTime}" pattern="HH:mm:ss"/> 
									</p>
									<p>
