...
<c:set var="movno" value="${movVO.movno}" scope="session"/> <!-- 若沒登入，無法對該電影評分+短評，here have to set a session attribute for the login page，把值給MemberServlet.java，再把值帶到MovServlet.java，再導回這一頁，這樣頁面的資料才不會不見。 -->
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
